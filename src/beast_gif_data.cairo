use super::interfaces::IBeastGifData;

#[starknet::contract]
mod beast_gif_data {
    use core::byte_array::ByteArrayTrait;
    use super::IBeastGifData;
    ...
    #[abi(embed_v0)]
    impl GifDataImpl of IBeastGifData<ContractState> {
        fn get_data_uri(self: @ContractState, beast_id: u8, shiny: bool) -> ByteArray {
