...
use super::beast_definitions::{get_beast_name, get_prefix, get_suffix, get_tier, get_type};
...
pub impl BeastSvgImpl of BeastSvgTrait {
    ...
    fn generate_beast_svg(beast: PackableBeast) -> ByteArray {
        ...
        svg
            .append(
                @"<text x='125' y='35' font-family='Arial' font-size='18' font-weight='bold' text-anchor='middle' fill='",
            );
        svg.append(@border_color);
        svg.append(@"'>");
        ...
        svg
            .append(
                @"<rect x='0' y='0' width='190' height='120' fill='#000000' fill-opacity='0.6' rx='5'/>",
            );

        // Type and Tier
        svg
            .append(
                @"<text x='95' y='20' font-family='Arial' font-size='12' text-anchor='middle' fill='#ffffff'>",
            );
