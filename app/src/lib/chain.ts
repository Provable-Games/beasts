...
/**
 * Cartridge Controller with the registry entrypoints pre-approved, so an
 * artist signs once and can then iterate on their species — update art, rotate
 * the minter, refresh metadata — without a popup for every change.
 *
